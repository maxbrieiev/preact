!(function () {
	...
	function k(l, t, u) {
		...
		return b(l, e, i, o, null);
	}
	function b(n, u, i, o, r) {
		var e = {
			type: n,
			props: u,
			key: i,
			...
			(r = u + a),
				...
				(i = n.__k[u] =
					...
					? ((i.__ = n),
						...
						-1 !== e && (s--, (o = t[e]) && (o.__u |= v)),
						null == o || null === o.__v
							? (-1 == e && a--, 'function' != typeof i.type && (i.__u |= p))
							: e !== r &&
								(e === r + 1
									? a++
									: e > r
					...
					: (o = t[r]) &&
						...
						o.__e &&
						0 == (o.__u & v) &&
						(o.__e == n.__d && (n.__d = M(o)), N(o, o, !1), (t[r] = null), s--);
		if (s)
			for (u = 0; u < c; u++)
				null != (o = t[u]) &&
					0 == (o.__u & v) &&
			...
			try {
				...
				(h.state = h.__s),
					...
					k &&
						...
						(d = h.getSnapshotBeforeUpdate(v, y)),
					I(
						n,
						_(
							(E =
	...
	function j(l, t, u, i, o, r, e, f, c) {
		...
		if (null === b) m === k || (f && l.data === k) || (l.data = k);
			...
			if (
				((r = r && n.call(l.childNodes)), (m = u.props || y), !f && null != r)
			)
