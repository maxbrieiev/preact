...
var p = n.Component.prototype.setState;
function d(n) {
	return (
		'table' === n ||
		'tfoot' === n ||
			...
			(n.options.__b = function (n) {
				...
				if ('function' == typeof n.type && n.type.propTypes) {
					if (
						...
						try {
							...
							E.lazyPropTypes.set(n.type, !0),
								console.warn(s + 'Component wrapped in lazy() is ' + t(l));
						} catch (n) {
							console.warn(
								s +
					...
					n.type.__f &&
						...
						})(n.type.propTypes, u, 0, t(n), function () {
							return c(n);
						});
				}
				i && i(n);
